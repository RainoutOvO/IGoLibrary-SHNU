...
namespace IGoLibrary_Winform.Controller
{
    public class GetCookieServiceImpl : IGetCookieService
    {
        ...
        {
            var client = new RestClient(string.Format("http://wechat.v2.traceint.com/index.php/urlNew/auth.html?r=https%3A%2F%2Flibseat.shnu.edu.cn%2Fweb%2Findex.html&code={0}&state=1",code));
